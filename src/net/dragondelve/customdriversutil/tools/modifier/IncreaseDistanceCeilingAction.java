 ...
 * This action increases the distance by increasing the ceiling.
 */
public class IncreaseDistanceCeilingAction extends FloorCeilingAction {
    ...
    public double performAction(double driverProperty) {
        ...
        return Math.min(driverProperty + ((driverProperty - floor) / delta) * (delta * modificationValue), 1.0);
    }
}
